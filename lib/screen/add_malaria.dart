              ...
              children: [
                ...
                if (isRdtPositive)
                  SizedBox(
                    ...
                    child: ListView(
                      ...
                      children: [
                        const Text('Malaria Parasite/ ငှက်ဖျားပိုးအမျိုးအစား'),
                        RadioListTile(
                            value: 'pf',
                            groupValue: rdtPosType,
                            title:
                                const Text('Plasmodium falciparum\nဖယ်ဆီပရမ်'),
                ...
                if (isRdtPositive)
                  FormHelper.inputFieldWidget(
                      context, medicineAmount ?? '', 'Amount', (onValidateVal) {
                    if (onValidateVal == null) {
                ...
                //     keyboardType: TextInputType.number,
                //     style: const TextStyle(fontSize: 15),
                //     // validator: (enteredAmount) {
                //     //   if ((selectedMedicine != null && enteredAmount == '') ||
                //     //       (selectedMedicine != null && enteredAmount == null)) {
                //     //     return 'Please enter amount';
                //     //   }
                //     //   return null;
                //     // },
                //     onChanged: (enteredAmount) => medicineAmount,
                //     // onSaved: (enteredAmount) {
                //     //   medicineAmount = enteredAmount;
                //     // },
                //     decoration: const InputDecoration(
                //       border: OutlineInputBorder(),
                //     ),
